...
const TrainEnum = {
    ...
    PLAY_A_CARD_FROM_THE_TABLE: "РАЗЫГРАТЬ КАРТУ СО СТОЛА (третья слева):",
    ...
    FROM_BOTTOM_TO_TOP: "СНИЗУ ВВЕРХ (вторая справа):",
    ...
    FIVE_OR_LESS: "ПЯТЬ ИЛИ МЕНЬШЕ (третья справа):",
