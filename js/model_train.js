...
const TrainEnum = {
    ...
    KARMA_CARDS_TEXT: "Эти карты можно разыграть независимо от значения предыдущей карты. Карты кармы, как и обычные карты, помещаются в стопку сброса.",
    GIVE_A_STACK_TO_A_FRIEND: "ОТДАТЬ СТОПКУ ДРУГУ:",
    GIVE_A_STACK_TO_A_FRIEND_TEXT: "Отдайте всю стопку сброса другому игроку и уберите карту кармы «Отдать стопку другу» из игры. Стопку сброса можно отдать любому игроку — даже тому, который уже успел избавиться от всех своих карт и выйти из игры." +
    ...
    PLAY_A_CARD_FROM_THE_TABLE: "РАЗЫГРАТЬ КАРТУ СО СТОЛА:",
    PLAY_A_CARD_FROM_THE_TABLE_TEXT: "Эта карта позволяет вам разыграть одну карту со стола до того, как вы разыграли все карты из руки. Помните о последовательности: вы не можете разыграть карту, лежащую рубашкой вверх, до того, как вы разыграли все лежащие лицевой стороной вверх карты. Если перед вами на столе не осталось карт, то вы можете разыграть любую карту из вашей руки. На карту «Разыграть карту со стола» можно положить любую карту.",
    FROM_BOTTOM_TO_TOP: "СНИЗУ ВВЕРХ:",
    FROM_BOTTOM_TO_TOP_TEXT: "Возьмите карту из-под низа стопки сброса и поместите её на карту «Снизу вверх». Следующий игрок кладёт свою карту на неё. Если карта из-под низа стопки сброса — это ещё одна карта «Снизу вверх» или карта «Разыграть карту со стола», то следующий игрок может разыграть любую карту.",
    FIVE_OR_LESS: "ПЯТЬ ИЛИ МЕНЬШЕ",
